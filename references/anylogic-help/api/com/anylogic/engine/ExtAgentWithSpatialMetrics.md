*来源 (Source): <https://anylogic.help/api/com/anylogic/engine/ExtAgentWithSpatialMetrics.html>*
...
```
@AnyLogicInternalAPI
public interface ExtAgentWithSpatialMetrics
extends ExtAnimationParams
```
