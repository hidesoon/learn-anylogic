*来源 (Source): <https://anylogic.help/api/com/anylogic/engine/AgentConstants.html>*
...
| `static final MessageDeliveryType` | `RANDOM_NEIGHBOR` | This destination type is available only in discrete agents |
...
| `static final SpaceType` | `SPACE_CONTINUOUS_2D` | Deprecated. use [`SPACE_CONTINUOUS`](#SPACE_CONTINUOUS) |
| `static final SpaceType` | `SPACE_DISCRETE` |  |
| `static final SpaceType` | `SPACE_DISCRETE_2D` | Deprecated. use [`SPACE_DISCRETE`](#SPACE_DISCRETE) |
...
| `static final Navigation3DType` | `WINDOW_3D_NAVIGATION_FULL` | 3D Window navigation mode constant.  Navigation is fully allowed |
| `static final Navigation3DType` | `WINDOW_3D_NAVIGATION_LIMITED_TO_Z_ABOVE_ZERO` | 3D Window navigation mode constant.  Navigation is only allowed above Z=0 plane |
| `static final Navigation3DType` | `WINDOW_3D_NAVIGATION_NONE` | 3D Window navigation mode constant.  Navigation is prohibited.  Default when window is linked with camera. |
| `static final Navigation3DType` | `WINDOW_3D_NAVIGATION_ROTATION_ONLY` | 3D Window navigation mode constant.  Navigation mode where user is able to rotate view only.  Can be used when window is linked with camera. |
