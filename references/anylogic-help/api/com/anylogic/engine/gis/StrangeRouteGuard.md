*来源 (Source): <https://anylogic.help/api/com/anylogic/engine/gis/StrangeRouteGuard.html>*

---

Package [com.anylogic.engine.gis](package-summary.md)

# Class StrangeRouteGuard
...
com.anylogic.engine.gis.StrangeRouteGuard
...
```
@AnyLogicInternalAPI
public class StrangeRouteGuard
...
| --- | --- |
| `StrangeRouteGuard(IGISRouteFinder base)` |  |
