*来源 (Source): <https://anylogic.help/api/com/anylogic/engine/gis/YoursOSMRouteFinder.html>*

---

Package [com.anylogic.engine.gis](package-summary.md)

# Class YoursOSMRouteFinder
...
```
@AnyLogicInternalAPI
public class YoursOSMRouteFinder
...
| --- | --- |
| `YoursOSMRouteFinder(RouteProviderTransportType transportType, RoutingMethod routingMethod)` |  |
